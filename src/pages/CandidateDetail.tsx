    ...
    <div className="flex flex-col gap-8 pb-12 max-w-5xl mx-auto">
      ...
      <header className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between print:hidden">
        <div className="flex flex-col">
          <Link to="/" className="text-xs font-semibold text-zinc-500 hover:text-zinc-900 flex items-center gap-1 mb-4 w-fit">
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Aids Detectees */}
        <section className="flex flex-col gap-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8 bg-gradient-to-br from-white to-zinc-50/50">
